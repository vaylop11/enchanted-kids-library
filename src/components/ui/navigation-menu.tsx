  ...
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        ...
        "data-[state=open]:backdrop-blur-sm data-[state=open]:bg-gradient-to-b data-[state=open]:from-blue-500/10 data-[state=open]:to-blue-500/5",
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-blue-500/20 shadow-md" />
  </NavigationMenuPrimitive.Indicator>
))
