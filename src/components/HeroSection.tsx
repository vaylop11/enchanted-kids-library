...
const HeroSection = () => {
  ...
  return (
    <section
      className="relative py-20 md:py-28 bg-gradient-to-b from-purple-50/60 via-background to-muted overflow-hidden"
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-6">
          <h1
            id="hero-heading"
            className="text-4xl md:text-6xl font-bold tracking-tight leading-tight text-foreground mb-3"
          >
            {language === "ar" ? (
              <>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center md:justify-start">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="px-8 border-purple-700 text-purple-800 hover:bg-purple-100"
            >
              <Link
                to="/blog"
                aria-label={
